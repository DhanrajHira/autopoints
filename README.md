...
- `simulations/gem5-config-<sha>.py`: immutable copy of the gem5 config used by the simulation campaign. Each `simulation.meta.json` records the source config, copied config, and SHA-256 hash.
